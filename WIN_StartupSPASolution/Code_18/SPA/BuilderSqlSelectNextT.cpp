#include "BuilderSqlSelectNextT.h"

string BuilderSqlSelectNextT::Build_Any_Any()
{
	char sqlBuf[512];
...
string BuilderSqlSelectNextT::Build_Any_Specific(string input2)
{
	char sqlBuf[512];
	sprintf_s(sqlBuf, "with recursive nextT as ("
...
string BuilderSqlSelectNextT::Build_Any_Synonym(string input2)
{
	char sqlBuf[512];
	sprintf_s(sqlBuf, "with recursive nextT as ("
...
string BuilderSqlSelectNextT::Build_Synonym_Any(string input1)
{
	char sqlBuf[512];
	sprintf_s(sqlBuf, "with recursive nextT as ("
...
string BuilderSqlSelectNextT::Build_Synonym_Synonym(string input1, string input2)
{
	char sqlBuf[600];
...
string BuilderSqlSelectNextT::Build_Synonym_Specific(string input1, string input2)
{
	char sqlBuf[512];
	sprintf_s(sqlBuf, "select * from ("
		"with recursive nextT as ( "
...
string BuilderSqlSelectNextT::Build_Specific_Any(string input1)
{
	char sqlBuf[512];
	sprintf_s(sqlBuf, "with recursive nextT as ( "
...
string BuilderSqlSelectNextT::Build_Specific_Specific(string input1, string input2)
{
	char sqlBuf[512];
	sprintf_s(sqlBuf, "select * from ("
		"with recursive nextT as ("
...
string BuilderSqlSelectNextT::Build_Specific_Synonym(string line_num, string entity)
{
	char sqlBuf[600];
	sprintf_s(sqlBuf, "select * from ("
		"with recursive nextT as ("
