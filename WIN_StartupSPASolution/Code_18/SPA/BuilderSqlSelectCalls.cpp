#include "BuilderSqlSelectCalls.h"
...
BuilderSqlSelectCalls::BuilderSqlSelectCalls() {
}

string BuilderSqlSelectCalls::GetSql(IClConstrain& re, IDescriberClConstrain& describer)
{
