...
public:
	...
	static string GetCall_Any_Synonym(string frontSql, string input2); // Call(_, procedure)
	static string GetCall_Any_Specific(string frontSql, string input2); // Call(_, "Second")
	static string GetCall_Synonym_Any(string frontSql, string input1); // Call(procedure, _)
	static string GetCall_Specific_Any(string frontSql, string input1); // Call("First", _)
	static string GetCall_Synonym_Synonym(string frontSql, string input1, string input2); // Call(procedure, procedure)
	static string GetCall_Synonym_Specific(string frontSql, string input1, string input2); // Call(procedure, "Second")
	static string GetCall_Specific_Synonym(string frontSql, string input1, string input2); // Call(("First",, procedure)
