#include "BuilderSqlSelectParentT.h"

string BuilderSqlSelectParentT::Build_Any_Any()
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectParentT::Build_Synonym_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectParentT::Build_Synonym_Synonym(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectParentT::Build_Synonym_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectParentT::Build_Specific_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectParentT::Build_Specific_Synonym(string input1, string input2)
{
	char sqlBuf[512] = {};
