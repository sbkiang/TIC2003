#include "BuilderSqlSelectUses.h"

string BuilderSqlSelectUses::Build_AnyPrintAssign_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyCall_Any()
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyProcedure_Any()
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyWhileIf_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_Any_Any()
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyPrintAssign_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyCall_Specific(string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyProcedure_Specific(string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_AnyWhileIf_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_Any_Specific(string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificPrintAssign_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificCall_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificProcedure_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificWhileIf_Any(string input1)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificPrintAssign_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificProcedure_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string BuilderSqlSelectUses::Build_SpecificWhileIf_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
BuilderSqlSelectUses::BuilderSqlSelectUses()
{
}

string BuilderSqlSelectUses::GetSql(IClConstrain& re, IDescriberClConstrain& describer) {
	...
	if (input1IsAny && input2IsAny) { // Uses(entity, variable/_)
		...
		else if (describer.Input1IsStmtOrWildcard()) { // Uses(stmt/_, variable/_)
