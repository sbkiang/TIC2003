...
#include "IDescriberClRelation.h"

using namespace std;

// describes whether the inputs in ClRelation is synonym, is wildcard
class DescriberClRelation : public IDescriberClRelation {
private:
...
public:
	DescriberClRelation(ClRelation re, map<string, string> synEntMap);
