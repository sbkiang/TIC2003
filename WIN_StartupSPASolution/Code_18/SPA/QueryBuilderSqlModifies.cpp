#include "QueryBuilderSqlModifies.h"

string QueryBuilderSqlModifies::Build_AnyReadAssign_Any(string input1)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyCall_Any()
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyProcedure_Any()
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyWhileIf_Any(string input1)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_Any_Any()
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyReadAssign_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyCall_Specific(string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyProcedure_Specific(string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_AnyWhileIf_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_Any_Specific(string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificReadAssign_Any(string input1)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificCall_Any(string input1)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificProcedure_Any(string input1)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificWhileIf_Any(string input1)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificReadAssign_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificCall_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificProcedure_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
...
string QueryBuilderSqlModifies::Build_SpecificWhileIf_Specific(string input1, string input2)
{
	char sqlBuf[512] = {};
